-- ============================================================
-- Migration: Create SKU Conversion Master Data
-- Date: 07/06/2026
-- ============================================================

-- 1. Create Conversion Master Data Table
CREATE TABLE IF NOT EXISTS public.cm_skus_conversao (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    product_id INTEGER NOT NULL REFERENCES public.products(id) ON DELETE CASCADE,
    codigo_integracao VARCHAR(100), -- Neutral integration code
    ...
    weight_pallet_kg NUMERIC(10, 4), -- Renamed from peso_pallet_kg to match schema English preference if needed, but keeping weight_pallet_kg
...
-- 3. Overlap Validity Checker Trigger
CREATE OR REPLACE FUNCTION public.check_cm_skus_conversao_overlap()
RETURNS TRIGGER AS $$
DECLARE
    overlap_count INTEGER;
BEGIN
    -- Only active conversions check for validity date overlaps
...
-- 5. Seed Conversion Data dynamically for all 29 products
