-- ==============================================================================
-- MIGRATION: 20260918_add_natureza_to_public_sales.sql
-- OBJETIVO:
-- Adicionar cod_natureza e desc_natureza à view public.sales para viabilizar
-- a regra comercial homologada de Sell-In KA (exclusão de devoluções 4040000 de
-- impróprios/perdas do sell-in comercial).
--
-- COMPATIBILIDADE:
-- 1. As novas colunas são adicionadas estritamente ao final do SELECT (colunas 39 e 40).
-- 2. Todas as 38 colunas existentes mantêm exatamente a mesma ordem, nomes e tipos.
-- 3. A view dependente public.vw_orphan_partners_report não sofre impacto nem precisa de rebuild.
-- 4. Retrocompatibilidade de 100% com consultas e consumidores existentes.
-- ==============================================================================
