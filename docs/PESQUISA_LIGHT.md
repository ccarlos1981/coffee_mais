...
* **Entrada de Dados:**
  - Input textual para rede com botões de sugestões rápidas de toque (Super Nosso, Verdemar, etc.).
  - Input decimal de moeda para Preço Flat e seletor amigável (toggle) entre Moído e Grão.
  - Input decimal de moeda para Preço Gourmet.
