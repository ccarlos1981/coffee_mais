...
import { FeriasCalendar } from "./FeriasCalendar";
import { AlertTriangle } from "lucide-react";
import Link from "next/link";

export const metadata = {
  title: "Calendário de Férias - Coffee Mais",
  description: "Visualização e planejamento de férias dos gerentes.",
};

export default async function GenteGestaoFeriasPage() {
      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-foreground">
        <div className="max-w-md w-full p-8 rounded-2xl bg-background-card border border-border text-center space-y-4 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-sm text-foreground-secondary leading-relaxed">
            Seu cargo ({role || "Sem cargo definido"}) não possui permissões necessárias para visualizar ou alterar o Calendário de Férias.
          </p>
