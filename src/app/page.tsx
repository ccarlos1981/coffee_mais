...
const allModules: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Férias", permission: "Gente e Gestão", description: "Calendário de Férias", href: "/gente-gestao/ferias", icon: CalendarDays, color: "from-emerald-600 to-emerald-800", ready: true },
