...
interface ForecastRedeGridProps {
  redes: ForecastDimensional[];
  loading?: boolean;
}

export const ForecastRedeGrid: React.FC<ForecastRedeGridProps> = ({
  redes,
  loading = false,
}) => {
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-5 shadow-sm space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h3 className="text-sm font-bold text-foreground">Forecast por Rede / Matriz</h3>
          <p className="text-[11px] text-muted-foreground">Projeção das principais contas de redes</p>
        </div>
      </div>
