...
import { Upload, DollarSign, BarChart3, TrendingUp, History, Lock, Unlock, ArrowLeft, Loader2, CheckCircle2, AlertCircle, RefreshCw, Undo2, Home } from "lucide-react";
...
export default function DREAuditoriaPage() {
      ...
      <nav className="cm-navbar px-6 py-4 flex items-center justify-between border-b border-border bg-elevated/50">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-lg text-foreground flex items-center gap-2">
            <History className="w-5 h-5 text-gold" /> Auditoria e Fechamento DRE
          </span>
        </div>
        <ThemeToggle />
      </nav>
