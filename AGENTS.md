...
## 85. Baseline Oficial — Trilha Comercial End-to-End (Follow-up Prescritivo, RPS Gap Recovery, CRM, Alertas & Cockpit)
...
3. **Faturamento Médio 3M (Baseline Homologado)**:
   ...
   - **Casos Críticos Auditados (desvio 0,00 em todos)**:
     - ZAFFARI (RS): R$ 687.503,53/mês
     - ZAFFARI (SP): R$ 51.839,19/mês
     - FORT (SC): R$ 137.355,33/mês
     - FORT (SP): R$ 8.197,27/mês
     - OBA SP: R$ 237.824,29/mês
     - OBA DF: R$ 69.986,73/mês
     - ASSAI (Luiz): R$ 22.724,00/mês
     - ASSAI (John Guedes): R$ 14.614,47/mês
     - MATEUS: R$ 15.873,40/mês
     - NOVO ATAC: R$ 0,00/mês
...
8. **RBAC Server-Side**:
   ...
   - **Gerente Regional**: O servidor (`obterDadosFarolGerencial`) filtra o universo estritamente por `r.manager === gerenteLogado` antes de qualquer retorno ao cliente. Cada gerente recebe somente sua carteira. Ranking consolidado omitido. Controles administrativos bloqueados server-side com 403. Zero vazamento entre carteiras.
...
| G1 | Deploy real | PASS |
| G2 | Universo = 67 | PASS |
| G3 | 6 Distribuidores excluídos | PASS |
| G4 | Nenhum Distribuidor no Farol | PASS |
| G5 | ZAFFARI SP presente | PASS |
| G6 | 29 Cartas | PASS |
| G7 | 38 faltantes | PASS |
| G8 | Cobertura 43,3% | PASS |
| G9 | Farol por gerente | PASS |
| G10 | Faturamento 3M | PASS |
| G11 | Casos críticos de faturamento | PASS |
| G12 | Ranking | PASS |
| G13 | WhatsApp | PASS |
| G14 | Inclusão Admin | PASS |
| G15 | Exclusão Admin | PASS |
| G16 | Reativação Admin | PASS |
| G17 | Distribuidor bloqueado de inclusão | PASS |
| G18 | Auditoria | PASS |
| G19 | RBAC Admin | PASS |
| G20 | RBAC John | PASS |
| G21 | RBAC Leandro | PASS |
| G22 | RBAC Luiz | PASS |
| G23 | RBAC Julliano | PASS |
| G24 | Filtros AND | PASS |
| G25 | Casos multioperação | PASS |
| G26 | Integridade das Cartas | PASS |
| G27 | Gestão de Cartas | PASS |
| G28 | Farol > R$80 mil | PASS |
| G29 | Preview/PDF/Upload | PASS |
| G30 | Storage | PASS |
| G31 | Performance | PASS |
| G32 | TypeScript | PASS |
| G33 | Build | PASS |

**Resultado: 33/33 PASS — 100% de conformidade — Mutações durante o Gate: 0 — Desvio financeiro: 0,0000%**
